        ...
        $structure = [
            ...
            'wall-insulation' => [
                ...
                'calculations' => [
                    ...
                    'measures' => [
                        'repair_joint'    => [
                            'label' => Translation::translate('wall-insulation.taking-into-account.repair-joint.label'),
                        ...
                        'clean_brickwork' => [
                            'label' => Translation::translate('wall-insulation.taking-into-account.clean-brickwork.label'),
                        ...
                        'impregnate_wall' => [
                            'label' => Translation::translate('wall-insulation.taking-into-account.impregnate-wall.label'),
                        ...
                        'paint_wall' => [
                            'label' => Translation::translate('wall-insulation.taking-into-account.wall-painting.label'),
        ...
        foreach ($igShorts as $igShort) {
            ...
            if ($igShort == end($igShorts)) {
                $structure['insulated-glazing']['calculations'] = [
                    ...
                    'measures' => [
                        'paintwork' => [
                            'label' => Translation::translate('insulated-glazing.taking-into-account.paintwork.label'),
            ...
            if ($roofType->short == $roofTypes1->last()->short) {
                ...
                $structure['roof-insulation']['calculations'] = [
                    'flat'    => [
                        ...
                        'measures' => [
                            'replace' => [
                                'label' => Translation::translate('roof-insulation.flat.indicative-costs-replacement.label'),
                    ...
                    'pitched' => [
                        ...
                        'measures' => [
                            'replace' => [
                                'label' => Translation::translate('roof-insulation.pitched.indicative-costs-replacement.label'),
