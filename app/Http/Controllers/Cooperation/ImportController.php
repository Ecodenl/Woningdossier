                    ...
                    if ($desiredInputSourceValue instanceof \stdClass && isset($desiredInputSourceValue->$whereColumn)) {
                        ...
                        if ($targetInputSourceValueCount > 1) {
                            ...
                            if ( ! empty($targetInputSourceValue)) {
                                $targetInputSourceValueQuery->update($this->createUpdateArray($targetInputSourceValue,
                                    $desiredInputSourceValue));
                            } else {
                            ...
                            if ($targetInputSourceValueQuery->first() instanceof \stdClass) {
                                ...
                                if ( ! empty($updateData = $this->createUpdateArray((array) $targetInputSourceValue, (array) $desiredInputSourceValue))) {
