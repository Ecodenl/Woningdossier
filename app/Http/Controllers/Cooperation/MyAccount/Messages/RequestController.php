...
class RequestController extends Controller
{
    ...
    public function update(Request $request, Cooperation $cooperation, $requestMessageId)
    {
        ...
        return redirect()->route('cooperation.my-account.messages.requests.index')->with('success', __('woningdossier.cooperation.my-account.messages.requests.update.success'));
    }
}
