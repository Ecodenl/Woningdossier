...
class MyPlanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($myAdvices as $adviceId => $data) {
            ...
            $inputSourceIdIsInputSourceOrUserIsObserving = $actionPlanExists && $advice->input_source_id == HoomdossierSession::getInputSource() || HoomdossierSession::isUserObserving();
