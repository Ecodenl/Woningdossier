...
class DownloadPdf extends Component
{
    ...
    public function mount(User $user)
    {
        ...
        $this->isFileBeingProcessed = $fileType->isBeingProcessed($user->building, $masterInputSource);
    ...
    {
        $this->isFileBeingProcessed = $this->fileType->isBeingProcessed($this->user->building, $this->masterInputSource);
    ...
    public function generatePdf()
    {
        ...
        abort_if($this->fileType->isBeingProcessed($this->user->building, $this->masterInputSource), 403);
