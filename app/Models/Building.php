 ...
 * @property int|null                                                                        $building_coach_statuses_count
 * @property \Illuminate\Database\Eloquent\Collection|\App\Models\BuildingElement[]          $buildingElements
 * @property int|null                                                                        $building_elements_count
 * @property \App\Models\BuildingFeature|null                                                $buildingFeatures
 ...
 * @property int|null                                                                        $building_statuses_count
 * @property \Illuminate\Database\Eloquent\Collection|\App\Models\BuildingVentilation[]      $buildingVentilations
 * @property int|null                                                                        $building_ventilations_count
 * @property \Illuminate\Database\Eloquent\Collection|\App\Models\CompletedStep[]            $completedSteps
 * @property int|null                                                                        $completed_steps_count
 * @property \Illuminate\Database\Eloquent\Collection|\App\Models\BuildingInsulatedGlazing[] $currentInsulatedGlazing
 * @property int|null                                                                        $current_insulated_glazing_count
 * @property \App\Models\BuildingPaintworkStatus|null                                        $currentPaintworkStatus
 * @property \App\Models\ExampleBuilding|null                                                $exampleBuilding
 * @property \App\Models\BuildingHeater|null                                                 $heater
 * @property \Illuminate\Database\Eloquent\Collection|\App\Models\PrivateMessage[]           $privateMessages
 * @property int|null                                                                        $private_messages_count
 * @property \App\Models\BuildingPvPanel|null                                                $pvPanels
 ...
 * @property int|null                                                                        $roof_types_count
 * @property \Illuminate\Database\Eloquent\Collection|\App\Models\StepComment[]              $stepComments
 * @property int|null                                                                        $step_comments_count
