 ...
 * @property int|null                                                                            $action_plan_advices_count
 ...
 * @property int|null                                                                            $cooperations_count
 * @property \App\Models\UserEnergyHabit|null                                                    $energyHabit
 ...
 * @property \Illuminate\Database\Eloquent\Collection|\App\Models\MeasureApplication[]           $measureApplicationInterest
 * @property int|null                                                                            $measure_application_interest_count
 * @property \Illuminate\Database\Eloquent\Collection|\App\Models\UserMotivation[]               $motivations
 * @property int|null                                                                            $motivations_count
 * @property \Illuminate\Database\Eloquent\Collection|NotificationSetting[]                      $notificationSettings
 * @property int|null                                                                            $notification_settings_count
 ...
 * @property \Illuminate\Database\Eloquent\Collection|\App\Models\Step[]                         $stepInterests
 * @property int|null                                                                            $step_interests_count
 * @property \Illuminate\Database\Eloquent\Collection|\App\Models\UserActionPlanAdviceComments[] $userActionPlanAdviceComments
 * @property int|null                                                                            $user_action_plan_advice_comments_count
 * @property \Illuminate\Database\Eloquent\Collection|\App\Models\UserInterest[]                 $userInterests
 * @property int|null                                                                            $user_interests_count
 *
