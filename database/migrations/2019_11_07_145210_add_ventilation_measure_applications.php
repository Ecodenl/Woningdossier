...
class AddVentilationMeasureApplications extends Migration
{
    ...
    public function up()
    {
        ...
        // when general data is present we add it
        // otherwise the MeasureApplication table seeder will seed the data.
        if (DB::table('steps')->where('short', 'general-data')->exists()) {
