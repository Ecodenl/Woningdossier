...
class KeyFigureTemperaturesTableSeeder extends Seeder
{
    ...
    public function run()
    {
	    ...
	    $figures = [
		    ...
		    [
			    'measure_application' => 'Plaatsen van HR++ glas (alleen het glas)',
			    'insulating_glazing' => 'Enkelglas',
			    'building_heating' => 'Verwarmd, de meeste radiatoren staan aan',
			    'key_figure' => 20.32,
		    ],
		    ...
		    [
			    'measure_application' => 'Plaatsen van HR++ glas (inclusief kozijn)',
			    'insulating_glazing' => 'Enkelglas',
			    'building_heating' => 'Verwarmd, de meeste radiatoren staan aan',
			    'key_figure' => 21.64,
		    ],
		    ...
		    [
			    'measure_application' => 'Plaatsen van drievoudige HR beglazing (inclusief kozijn)',
			    'insulating_glazing' => 'Enkelglas',
			    'building_heating' => 'Verwarmd, de meeste radiatoren staan aan',
			    'key_figure' => 22.96,
		    ],
