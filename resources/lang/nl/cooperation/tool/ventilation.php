...
return [
    'index' => [
        'how' => [
            'title' => 'Hoe wordt de woning nu geventileerd?',
            'help' => '<p>Hier kunt u aangeven op welke manier frisse lucht nu binnenkomt. Er moet een keuze worden gemaakt uit de eerste drie opties of de laatste (geen ventilatie voorziening). Bij de eerste drie vragen zijn er meerdere opties mogelijk.</p>',
        ],
        'living-situation' => [
        ...
        'comment' => [
            ...
            'help' => '<p>Hier kunnen aanvullende opmerkingen worden gemaakt over de ventilatie van uw woning.</p>',
        ],
        'indication-for-costs' => [
            'title' => 'Indicatie voor kosten en baten voor kierdichting',
            'help' => '<p>Hier kunt u zien wat de indicatieve kosten voor deze maatregel zijn.</p>',
        ],
        'indication-for-costs-other' => [
            'title' => 'Indicatie voor kosten en baten overige maatregelen',
            'help' => '<p>Hier kunt u zien wat de indicatieve kosten voor de overige maatregelen zijn.</p>',
            'text' => 'Het berekenen van kosten en baten van ventilatiesystemen is maatwerk. Om te bepalen welke oplossing voor uw woning de beste is wordt geadviseerd om dit door een specialist te laten beoordelen.',
        ],
        'costs' => [
            'gas' => [
                'title' => 'Gasbesparing',
