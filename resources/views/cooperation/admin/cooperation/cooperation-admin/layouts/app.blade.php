                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <ul id="sidebar-main" class="sidebar list-group panel-collapse @if(str_replace(['coordinator.', 'cooperation-admin.index', 'assign-role'], '', \Route::currentRouteName()) != \Route::currentRouteName()) open collapse in @else collapse @endif" aria-expanded="true">
                                ...
                                <li class="list-group-item @if(in_array(Route::currentRouteName(), ['cooperation.admin.cooperation.cooperation-admin.coordinator.index', 'cooperation.admin.cooperation.cooperation-admin.coordinator.create'])) active @endif"><a  href="{{route('cooperation.admin.cooperation.cooperation-admin.coordinator.index')}}">@lang('woningdossier.cooperation.admin.cooperation.cooperation-admin.side-nav.coordinator')</a></li>
