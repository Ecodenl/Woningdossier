...
@section('coordinator_content')
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <form action="{{route('cooperation.admin.cooperation.coordinator.coach.store')}}" id="register" method="post"  >
                    {{csrf_field()}}
                    ...
                    <div id="resident-info" class="col-md-6">
                        <div class="row">
                            <div class="form-group{{ $errors->has('postal_code') || $errors->has('number') ? ' has-error' : '' }}">
                                <div class="col-md-4">
                                    <label for="postal_code" class="">@lang('woningdossier.cooperation.admin.cooperation.coordinator.coach.create.form.postal-code')<span class="">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <label for="number" class="">@lang('woningdossier.cooperation.admin.cooperation.coordinator.coach.create.form.number')<span class="">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <label for="house_number_extension" class="">@lang('woningdossier.cooperation.admin.cooperation.coordinator.coach.create.form.house-number-extension')</label>
                                    <input id="house_number_extension" type="text" class="form-control" name="house_number_extension" placeholder="@lang('woningdossier.cooperation.admin.cooperation.coordinator.coach.create.form.house-number-extension')" value="{{ old('house_number_extension') }}" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group{{ $errors->has('street') ? ' has-error' : '' }}">
                                    <label for="street" class="">@lang('woningdossier.cooperation.admin.cooperation.coordinator.coach.create.form.street')<span class="">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                    <label for="city" class="">@lang('woningdossier.cooperation.admin.cooperation.coordinator.coach.create.form.city')<span class="">*</span></label>
