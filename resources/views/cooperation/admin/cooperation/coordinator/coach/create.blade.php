                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group" {{ $errors->has('email') ? ' has-error' : '' }}>
                                    ...
                                    <input  value="{{old('email')}}" type="email" class="form-control" placeholder="@lang('woningdossier.cooperation.admin.cooperation.coordinator.coach.create.form.email')..." name="email">
                                    @if ($errors->has('email'))
                                        <span class="help-block">
