                    ...
                    @component('cooperation.admin.layouts.components.chat-messages')
                        @forelse($buildings as $building)
                            ...
                            @if($privatePrivateMessage instanceof \App\Models\PrivateMessage)
                                <a href="{{ route('cooperation.admin.cooperation.coordinator.messages.private.edit', ['buildingId' => $building->id]) }}">
                            ...
                            @if($publicPrivateMessage instanceof \App\Models\PrivateMessage)
                                <a href="{{ route('cooperation.admin.cooperation.coordinator.messages.public.edit', ['buildingId' => $building->id]) }}">
                                    <li class="left clearfix">
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                                <strong class="primary-font">
