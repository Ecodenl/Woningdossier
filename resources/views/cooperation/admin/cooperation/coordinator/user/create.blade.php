...
@section('coordinator_content')
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <form action="{{route('cooperation.admin.cooperation.coordinator.user.store')}}" id="register"
                      method="post">
                    {{csrf_field()}}
                            ...
                            <div class="col-sm-12">
                                <div class="form-group {{ $errors->has('first_name') ? ' has-error' : '' }}">
                                    ...
                                    <input value="{{old('first_name')}}" type="text" class="form-control"
                                           name="first_name"
                                           placeholder="@lang('woningdossier.cooperation.admin.cooperation.coordinator.user.create.form.first-name')...">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group {{ $errors->has('last_name') ? ' has-error' : '' }}">
                                    ...
                                    <input value="{{old('last_name')}}" type="text" class="form-control"
                                           placeholder="@lang('woningdossier.cooperation.admin.cooperation.coordinator.user.create.form.last-name')..."
                                           name="last_name">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    <input type="email" value="{{old('email')}}" class="form-control"
                                           placeholder="@lang('woningdossier.cooperation.admin.cooperation.coordinator.user.create.form.email')..."
                                           name="email">
                                    @if ($errors->has('email'))
                                        <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('postal_code') || $errors->has('number') ? ' has-error' : '' }}">
                                <div class="col-md-4">
                                    <label for="postal_code"
                                           class="">@lang('woningdossier.cooperation.admin.cooperation.coordinator.user.create.form.postal-code')
                                ...
                                <div class="col-md-4">
                                    <label for="number"
                                           class="">@lang('woningdossier.cooperation.admin.cooperation.coordinator.user.create.form.number')
                                        <span class="">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <label for="house_number_extension"
                                           class="">@lang('woningdossier.cooperation.admin.cooperation.coordinator.user.create.form.house-number-extension')</label>
                                    <input id="house_number_extension" type="text" class="form-control"
                                           name="house_number_extension"
                                           placeholder="@lang('woningdossier.cooperation.admin.cooperation.coordinator.user.create.form.house-number-extension')"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group{{ $errors->has('street') ? ' has-error' : '' }}">
                                    <label for="street"
                                           class="">@lang('woningdossier.cooperation.admin.cooperation.coordinator.user.create.form.street')
                                        <span class="">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                    <label for="city"
                                           class="">@lang('woningdossier.cooperation.admin.cooperation.coordinator.user.create.form.city')
                                        <span class="">*</span></label>
                    ...
                    <div class="col-sm-12">
                        <button class="btn btn-primary btn-block"
                                type="submit">@lang('woningdossier.cooperation.admin.cooperation.coordinator.user.create.form.submit')
