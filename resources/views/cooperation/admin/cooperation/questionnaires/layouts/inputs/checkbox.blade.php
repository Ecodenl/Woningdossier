...
{{-- quick maths--}}
<label for="">@lang('cooperation/admin/cooperation/questionnaires.shared.types.default-option') {{$questionOptionCount + 1}} @lang('cooperation/admin/cooperation/questionnaires.shared.types.add')</label>
