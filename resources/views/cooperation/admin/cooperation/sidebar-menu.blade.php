        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <ul id="sidebar-main" class="sidebar list-group panel-collapse {{-- @if(str_replace(['assign-roles.', '.coach.', 'coordinator.index'], '', \Route::currentRouteName()) != \Route::currentRouteName()) --}}open collapse in {{--@else collapse @endif --}}" aria-expanded="true">
                    ...
                    <li class="list-group-item @if(in_array(Route::currentRouteName(), ['cooperation.admin.cooperation.coordinator.building-access.index', 'cooperation.admin.cooperation.coordinator.messages.public.edit', 'cooperation.admin.cooperation.coordinator.messages.private.edit'])) active @endif"><a href="{{route('cooperation.admin.cooperation.coordinator.building-access.index')}}">@lang('woningdossier.cooperation.admin.cooperation.coordinator.side-nav.buildings')</a></li>
