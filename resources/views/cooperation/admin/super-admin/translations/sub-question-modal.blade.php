    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-body">
                @foreach($subQuestion->text as $locale => $text)
                    <div class="form-group">
                        ...
                        <input class="form-control question-input" name="language_lines[{{$locale}}][question][{{$subQuestion->id}}]" value="{{$text}}">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">@lang('woningdossier.cooperation.admin.super-admin.translations.edit.close-modal')</button>
            </div>
        </div>
    </div>
</div>