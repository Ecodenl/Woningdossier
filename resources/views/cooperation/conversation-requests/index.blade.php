    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('form').on('submit', function (event) {
                if (!$('input[name=allow_access]').is(':checked') && $('#user-did-not-allow-access-to-his-building').val() || $('#user-already-had-contact-with-cooperation').val() == false || $('#user-did-not-allow-access-to-his-building').val() == true) {
