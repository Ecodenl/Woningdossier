                ...
                <tr>
                    <td class="content-cell"
                        ...
                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                            Beste bodhi looij,<br></p>
                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                            Er is een account voor u aangemaakt op <a href="http://hoom.woondossier.vm/home"
                                                                      target="_blank"
                                                                      style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;"></a><a
                                    href="http://hoom.woondossier.vm/home"
                                    style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">http://hoom.woondossier.vm/home</a><br><br>
                            Bevestig uw account door onderstaande link te volgen:</p>
                                                        ...
                                                        <tr>
                                                            <td align="center" bgcolor="#3498DB" width="150">
                                                                <a href="http://www.example.com"
                                                                   style="padding: 10px;width:150px;display: block;text-decoration: none;border:0;text-align: center ;font-family: Calibri, sans-serif, 'Open Sans';color: #ffffff;background: #3498DB;border: 1px solid #3498DB;line-height:17px;"
                                                                   class="button_link">
                                                                    Bevestig account
                                                                </a>
                                                            </td>
                        ...
                        <p style="word-break:break-all; font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                            ...
                            <a href=""
                               style=" display: block !important; max-width: 570px; font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">
                            ...
                            <tr>
                                <td class="content-cell" align="center"
                                    ...
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #AEAEAE; font-size: 12px; text-align: center;">
                                        © 2020 Hoomdossier. All rights reserved.</p>
                                </td>
                            </tr>
                        </table>
                    </td>
