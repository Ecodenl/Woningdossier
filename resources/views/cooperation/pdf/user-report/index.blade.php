...
<html lang="{{app()->getLocale()}}">
    ...
    @foreach(\App\Helpers\StepHelper::QUICK_SCAN_STEP_SHORTS as $quickScanStep)
        {{-- TODO: Use report data to generate the step summaries --}}

        @php unset($reportData[$quickScanStep]); @endphp
    @endforeach
