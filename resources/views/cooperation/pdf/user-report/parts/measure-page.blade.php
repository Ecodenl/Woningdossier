@php
    // some pages need a different layout / structure than the data gives us.
    // its easier, faster and more readable to do it in this way than do magic on all the array keys.
