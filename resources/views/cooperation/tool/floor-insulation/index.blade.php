                ...
                <div class="col-sm-12">
                    <div class="form-group add-space{{ $errors->has('element.' . $floorInsulation->id) ? ' has-error' : '' }}">
                        ...
                        <label for="element_{{ $floorInsulation->id }}" class="control-label">
                            <i data-toggle="modal" data-target="#floor-insulation-info"
                    ...
                    <div class="col-sm-12">
                        <div id="has-no-crawlspace"
                            ...
                            <label for="has_crawlspace" class=" control-label">
                                <i data-toggle="modal" data-target="#building_elements-crawlspace-info"
                                   class="glyphicon glyphicon-info-sign glyphicon-padding"></i>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div id="has-crawlspace-access"
                                 class="form-group add-space {{ $errors->has('building_elements.' . $crawlspace->id .'.extra') ? ' has-error' : '' }}">
                                <label for="crawlspace_access" class="control-label">
                                    <i data-toggle="modal" data-target="#crawlspace-access-info"
                                       class="glyphicon glyphicon-info-sign glyphicon-padding"></i>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group add-space{{ $errors->has('building_elements.' . $crawlspace->id .'.element_value_id') ? ' has-error' : '' }}">
                                <label for="crawlspace_height" class=" control-label">
                                    <i data-toggle="modal" data-target="#crawlspace-height-info"
                                       class="glyphicon glyphicon-info-sign glyphicon-padding"></i>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group add-space{{ $errors->has('building_features.floor_surface') ? ' has-error' : '' }}">
                            ...
                            <label for="surface" class=" control-label">
                                <i data-toggle="modal" data-target="#floor-surface-info"
                                   class="glyphicon glyphicon-info-sign glyphicon-padding"></i>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group add-space{{ $errors->has('building_features.insulation_surface') ? ' has-error' : '' }}">
                            ...
                            <label for="insulation_floor_surface" class=" control-label">
                                <i data-toggle="modal" data-target="#floor-insulation-surface-info"
                                   class="glyphicon glyphicon-info-sign glyphicon-padding"></i>
            ...
            <div class="row additional-info">
                <div class="col-sm-12">
                    <div class="form-group add-space{{ $errors->has('comment') ? ' has-error' : '' }}">
                        <label for="additional-info" class=" control-label"><i data-toggle="modal"
                                                                               data-target="#additional-info-info"
                                                                               class="glyphicon glyphicon-info-sign glyphicon-padding"></i>{{\App\Helpers\Translation::translate('general.specific-situation.title')}}
                        </label>
                        <?php
