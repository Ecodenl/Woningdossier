        ...
        <div id="start-information">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    {{--<input type="text" id="resident_count" class="form-control disabled" disabled="" value="{{isset(\App\Helpers\Hoomdossier::user()->energyHabit) ? \App\Helpers\Hoomdossier::user()->energyHabit->resident_count : ''}}">--}}
                    {{--</div>--}}
                    {{--</div>--}}
                    {{--</div>--}}
