                    ...
                    <tr>
                        ...
                        <td>
                            @if($measureType == "energy_saving")
                                <input class="interested-checker" name="advice[{{ $advice->id }}][{{$stepSlug}}][interested]" value="1" type="checkbox" id="advice-{{$advice->id}}-planned" @if($advice->planned == 1) checked @endif />
                            @else
