    ...
    <form class="form-horizontal" method="POST" action="{{ route('cooperation.tool.wall-insulation.store', ['cooperation' => $cooperation]) }}">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group add-space{{ $errors->has('house_has_insulation') ? ' has-error' : '' }}">
                        ...
                        <label for="house_has_insulation" class=" control-label"> <i data-toggle="collapse" data-target="#house-insulation-info" class="glyphicon glyphicon-info-sign"></i> @lang('woningdossier.cooperation.tool.wall-insulation.intro.filled-insulation')           </label>
                        ...
                        <div id="house-insulation-info" class="collapse">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group add-space{{ $errors->has('house_has_cavity') ? ' has-error' : '' }}">
                        <label for="house_has_cavity" class=" control-label"> <i data-toggle="collapse" data-target="#cavity-info" class="glyphicon glyphicon-info-sign"></i> @lang('woningdossier.cooperation.tool.wall-insulation.intro.has-cavity-wall') </label>
                        ...
                        <div id="cavity-info" class="collapse">
                            I would like to have some help full information right here !
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group add-space{{ $errors->has('is_facade_plastered_painted') ? ' has-error' : '' }}">
                        ...
                        <label for="is_facade_plastered_painted" class=" control-label"> <i data-toggle="collapse" data-target="#wall-painted" class="glyphicon glyphicon-info-sign"></i>  @lang('woningdossier.cooperation.tool.wall-insulation.intro.is-facade-plastered-painted') </label>
                        ...
                        <div id="wall-painted" class="collapse">
                            I would like to have some help full information right here to!
                        </div>
                    </div>
                ...
                <div id="painted-options" style="display: none;">
                    <div class="col-sm-6">
                        <div class="form-group add-space{{ $errors->has('is_facade_plastered_painted_surface') ? ' has-error' : '' }}">
                            <label for="is_facade_plastered_painted_surface" class=" control-label"><i data-toggle="collapse" data-target="#facade-painted-surface" class="glyphicon glyphicon-info-sign"></i> @lang('woningdossier.cooperation.tool.wall-insulation.intro.surface-paintwork') </label>
                        ...
                        <div id="facade-painted-surface" class="collapse">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group add-space{{ $errors->has('damage_paintwork_surface') ? ' has-error' : '' }}">
                            <label for="damage_paintwork" class=" control-label"> <i data-toggle="collapse" data-target="#damage-paintwork-surface" class="glyphicon glyphicon-info-sign"></i>@lang('woningdossier.cooperation.tool.wall-insulation.intro.damage-paintwork') </label>
                        ...
                        <div id="damage-paintwork-surface" class="collapse">
                            And i would like to have it to...
                        </div>
                    </div>
                </div>
        ...
        <div id="options">
            ...
            <div id="wall-joints" class="row">
                <div class="col-sm-6">
                    <div class="form-group add-space{{ $errors->has('is_facade_plastered_painted_surface') ? ' has-error' : '' }}">
                        <label for="wall_joints" class=" control-label"><i data-toggle="collapse" data-target="#wall-joints-info" class="glyphicon glyphicon-info-sign"></i>  @lang('woningdossier.cooperation.tool.wall-insulation.optional.flushing')           </label>
                    ...
                    <div id="wall-joints-info" class="collapse">
                        I would like to have some help full information right here !
                    </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group add-space{{ $errors->has('contaminated_wall_joints_surface') ? ' has-error' : '' }}">
                        <label for="contaminated_wall_joints" class=" control-label"><i data-toggle="collapse" data-target="#wall-joints-surface" class="glyphicon glyphicon-info-sign"></i>@lang('woningdossier.cooperation.tool.wall-insulation.optional.if-facade-dirty') </label>
                    ...
                    @endif
                    <div id="wall-joints-surface" class="collapse">
                        I would like to have some help full information right here !
                    </div>
                </div>
            ...
            <div id="facade-surface" class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group add-space{{ $errors->has('is_facade_plastered_painted') ? ' has-error' : '' }}">
                        <label for="facade_surface" class="control-label"><i data-toggle="collapse" data-target="#facade-surface-info" class="glyphicon glyphicon-info-sign"></i>@lang('woningdossier.cooperation.tool.wall-insulation.optional.not-right')           </label>
                    ...
                    <div id="facade-surface-info" class="collapse">
                        I would like to have some help full information right here !
                    </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group add-space{{ $errors->has('additional_info') ? ' has-error' : '' }}">
                        <label for="additional-info" class=" control-label"><i data-toggle="collapse" data-target="#additional-info-info" class="glyphicon glyphicon-info-sign"></i>@lang('woningdossier.cooperation.tool.wall-insulation.taking-into-account.additional-info')           </label>
                        ...
                        @endif
                        <div id="additional-info-info" class="collapse">
                            I would like to have some help full information right here !
                        </div>
