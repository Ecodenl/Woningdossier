<div x-data="{ dropdownOpen: !!'{{$shouldOpenAlert}}' }" class="relative" x-on:click.outside="dropdownOpen = false;" wire:ignore>
    <button x-on:click="dropdownOpen = !dropdownOpen" class="flex flex-wrap justify-center items-center">
